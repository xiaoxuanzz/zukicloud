...
if($mod == "site"){
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10"><input type="text" name="title" class="form-control" value="<?php echo htmlspecialchars($conf["title"]) ?>" autocomplete="off"></div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">网站关键词</label>
            <div class="col-sm-10"><input type="text" name="keywords" class="form-control" value="<?php echo htmlspecialchars($conf["keywords"]) ?>" autocomplete="off"></div>
        </div>
        <div class="form-group">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10"><input type="number" name="upload_size" class="form-control" value="<?php echo $conf["upload_size"] ?>" min="0" autocomplete="off"></div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">禁止上传格式</label>
            <div class="col-sm-10"><input type="text" name="type_block" class="form-control" value="<?php echo htmlspecialchars($conf["type_block"]) ?>" placeholder="exe|bat|cmd" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10"><input type="text" name="upload_code" class="form-control" value="<?php echo htmlspecialchars($conf["upload_code"]) ?>" placeholder="留空则不启用验证码" autocomplete="off">
            <p class="help-block">开启上传验证码后，用户上传文件时需输入此验证码</p></div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">并发上传数</label>
            <div class="col-sm-10"><input type="number" name="upload_concurrent" class="form-control" value="<?php echo max(1, min(50, intval($conf["upload_concurrent"]))) ?>" min="1" max="50" autocomplete="off">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10"><input type="text" name="admin_user" class="form-control" value="<?php echo htmlspecialchars($conf["admin_user"]) ?>" autocomplete="off"></div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">旧密码</label>
            <div class="col-sm-10"><input type="password" name="oldpwd" class="form-control" placeholder="不修改请留空" autocomplete="new-password"></div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">新密码</label>
            <div class="col-sm-10"><input type="password" name="newpwd" class="form-control" placeholder="不修改请留空" autocomplete="new-password"></div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">确认新密码</label>
            <div class="col-sm-10"><input type="password" name="newpwd2" class="form-control" autocomplete="new-password"></div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10"><button type="submit" class="btn btn-primary">保存设置</button></div>
        </div>
    ...
    <div class="row" style="margin-top:20px;">
        <div class="col-xs-6 col-sm-4 col-md-3" style="margin-bottom:15px;">
            <a href="?mod=site" class="btn btn-primary btn-lg btn-block">网站信息</a>
        </div>
        <div class="col-xs-6 col-sm-4 col-md-3" style="margin-bottom:15px;">
            <a href="?mod=upload" class="btn btn-success btn-lg btn-block">上传设置</a>
        </div>
        <div class="col-xs-6 col-sm-4 col-md-3" style="margin-bottom:15px;">
            <a href="?mod=user" class="btn btn-info btn-lg btn-block">用户设置</a>
        </div>
        <div class="col-xs-6 col-sm-4 col-md-3" style="margin-bottom:15px;">
            <a href="?mod=admin" class="btn btn-warning btn-lg btn-block">管理员设置</a>
        </div>
        <div class="col-xs-6 col-sm-4 col-md-3" style="margin-bottom:15px;">
            <a href="./set_stor.php" class="btn btn-danger btn-lg btn-block">存储设置</a>
        </div>
    </div>
    <?php
}
